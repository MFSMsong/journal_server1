...
public interface ActivityMapper {
    ...
    @org.apache.ibatis.annotations.Select("SELECT u.user_id as userId, u.avatar_url as avatar, IFNULL(aur.nickname, u.nickname) as nickname FROM activity_user_rel aur LEFT JOIN users u ON aur.user_id = u.user_id WHERE aur.activity_id = #{activityId} AND aur.user_id = #{userId}")
